			...
			<!-- Header -->
				<div id="header-wrapper">
					<div id="header">
						...
						<!-- Logo -->
							<h1><a href="index.php">Dosika Offers</a></h1>
						...
						<!-- Banner -->
							<section id="banner">
								<header>
									<h2>Howdy. Welcome to our offers.</h2>
									<p>Specially tailored for you!</p>
								</header>
							</section>
						...
						<div class="row">
							<div class="12u">
								...
								<!-- Copyright -->
									<div id="copyright">
										<ul class="links">
											<li>&copy; WASP Africa. All rights reserved.</li><li>Design: <a href="#">WASP</a></li>
										</ul>
									</div>
