...
if(isset($_POST['subscribe'])){
	...
	if(strlen($_POST['mobilenum'])==0){
		...
		if(strlen($_POST['mobilenum'])<9){
			...
			$sent = mssql_query("insert into ozekimessageout (sender, receiver, msg, scheduledtime, flag, status) values ('21208', '$phone_num', 'Welcome to BrainGame. To begin, send QUIZ to 21208, and start WINNING NOW!', '$now', '0', 'send')", $dbhandleX); 
