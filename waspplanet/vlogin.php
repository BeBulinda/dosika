				...
				<div class="col-md-12 total-news">
				 	<div class="sign_up text-center">
						...
						<form action="vlogin.php" method="post" role="form">
                         ...
                         <p>I dont have an account. <a href="vreg_user.php">SIGNUP</a></p>
<?php
    require('dbconn.php');
   if(isset($_POST['username'])&& isset($_POST['password'])){
       ...
       if(!empty($username)&&!empty($password)){
        $activate=mysql_query("SELECT * FROM `subscriber` WHERE `username`='$username' AND `active`='1'");
            $activate_run = mysql_num_rows($activate);
        $query="SELECT * FROM `subscriber` WHERE `username`='$username' AND `password`='$password'";
            ...
            echo 'OK.';}else{
                              echo 'Please confirm your account using the code sent to the email you used to signup.<a href = "vconfirmation.php">HERE!</a>';
                          }
            }
       }
   }
