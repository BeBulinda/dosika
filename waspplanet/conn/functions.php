...
{
	//Click here http://www.waspplanet.com/index.php?tkn='.$url_iid.'&req='.$content_type_id.' to go to wasp planet downloads.
	$msg = 'Welcome to DOSIKA HD GAMES. To download GAMES go to http://www.dosika.co.ke/waspplanet/0g/';
